...
import { Mail, Phone, MapPin, Github, Linkedin, User, GraduationCap, Code, Star, Shield, Database, IdCard, Briefcase, NetworkIcon } from 'lucide-react'
...
function Navigation() {
  ...
  return (
    <motion.nav 
      className="fixed top-0 w-full bg-gradient-to-r from-slate-800 to-slate-900 text-white p-4 z-50 shadow-lg"
      initial={{ y: -100 }}
      animate={{ y: 0 }}
  ...
  const projects = [
    {
      ...
      icon: Shield,
      technologies: ["Python", "Mongo db","Ai", "Flask", "Web Security", "SQL Injection", "Cross-Site Scripting", "Cross-Site Request Forgery"],
      features: [
...
projects.push({
    ...
    description: "Responsive front-end for online store with product catalog and shopping cart functionality It a frontent website only",
    icon: Briefcase,
...
// Add more projects as needed  
  projects.push({
    ...
    icon: User,
    technologies: ["Ardino", "Rfid", "C++","Database"],
    features: [
      "RFID card scanning",
